...
$(document).ready(function() {
      ...
      $.get("containers_cmd.php?status=1", function(data) { 
          if (data=="Ko") {
            ...
            txt = "Votre terminal s\'initialise. Il créé son réseau dédié et démarre une nouvelle instance... Laissez lui "+tt+" secondes...";
...
<?php
    ...
    if (isset($_SESSION['login'] )) {
        ...
        echo '<a href="https://'.$_SERVER['HTTP_HOST'].'/ctf-tool-xterm_'.$_SESSION['uid'].'/" target="_blank"><pre>[Mon terminal]</pre></a>';
        echo "</br>";
